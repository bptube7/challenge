...
describe('Podcast', () => {
  it('renders Podcast component', async () => {
    ...
    await waitFor(() => {
      ...
      const episodeDateElement = screen.getByText(/25\/02\/2023/);
      expect(episodeDateElement).toBeInTheDocument();
      expect(episodeDateElement).toBeVisible();

      const episodeDurationElement = screen.getByText(/02:36:20/);
